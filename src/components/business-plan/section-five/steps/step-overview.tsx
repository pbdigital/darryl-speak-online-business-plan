          ...
          <div className="rounded-3xl border-2 border-slate-100 bg-white p-8 shadow-sm">
            ...
            <div className="mb-6 grid grid-cols-1 gap-3 md:grid-cols-2">
              <div className="rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5A</span>
                <p className="text-sm text-slate-600">Project Matrix</p>
              </div>
              <div className="rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5B</span>
                <p className="text-sm text-slate-600">Exploring Your Resources</p>
              </div>
              <div className="rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5C</span>
                <p className="text-sm text-slate-600">Defining Your Ideal Client</p>
              </div>
              <div className="rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5D</span>
                <p className="text-sm text-slate-600">Your Prospecting Mix</p>
              </div>
              <div className="rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5E</span>
                <p className="text-sm text-slate-600">Your Marketing Mix</p>
              </div>
              <div className="rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5F</span>
              ...
              <div className="col-span-1 rounded-2xl border border-slate-100 bg-[#e8f4f8]/30 p-4 md:col-span-2">
                <span className="text-xs font-bold uppercase tracking-wider text-[#1a2744]">Part 5G</span>
