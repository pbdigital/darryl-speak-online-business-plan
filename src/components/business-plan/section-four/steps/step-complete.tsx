...
export function StepComplete() {
  ...
  return (
    <StepContainer>
      {/* Success Hero */}
      <div className="mb-8 rounded-3xl bg-[#1a2744] p-8 text-center text-white shadow-xl md:p-12">
      ...
      <div className="mb-8 rounded-2xl border-2 border-[#1a2744]/20 bg-[#e8f4f8]/30 p-6">
        <p className="text-sm leading-relaxed text-slate-700">
          <strong className="text-[#1a2744]">Remember:</strong> By clarifying what strengthens
      ...
      <div className="rounded-2xl border-2 border-slate-100 bg-white p-6">
        ...
        <ul className="space-y-3 text-sm text-slate-600">
          <li className="flex items-start gap-2">
            ...
            <span>
              Complete <strong className="text-[#1a2744]">Section 5: Accountability & Progress Tracking</strong> to
